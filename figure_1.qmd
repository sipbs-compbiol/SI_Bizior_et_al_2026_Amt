...
We process the `NeRh50_Table_S1_raw_data_used_in_figures.csv` dataset to obtain the data for this analysis (@tbl-q2-compose).
...
#| tbl-subcap:
#|    - "Figure 2B(i): Maximum amplitude, H2O"
#|    - "Figure 2B(ii): Decay rate, H2O"
#|    - "Figure 2D(i): Maximum amplitude, LPR5"
#|    - "Figure 2D(ii): Decay rate, LPR5"
#|    - "Figure 2F(i): Maximum amplitude, D2O"
#|    - "Figure 2F(ii): Decay rate, D2O"
#| layout-ncol: 2
...
```{r}
#| label: fig-q2-pubfig
#| fig-cap: "WT measurements across three LPRs and three experimental conditions, representing figures 2B, 2D, and 2F from the draft manuscript. , with Sidak-adjusted _p_-values indicated" 
#| fig-subcap:
#|    - "Figure 2B(i)"
#|    - "Figure 2B(ii)"
#|    - "Figure 2D(i)"
