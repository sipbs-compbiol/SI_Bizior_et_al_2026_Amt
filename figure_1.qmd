---
title: "Figure 2: `WT` maximum amplitudes and decay rate constants"
---
...
We begin with maximum amplitude and  `01_WT_solvent_exchange_conditions.csv` dataset (@tbl-q2-compose).

```{r}
#| label: tbl-q2-compose
#| tbl-cap: "Measurements for `WT` across `H2O`, `D2O` and `D2O>H2O` conditions at varying levels of `LPR`" 
#| tbl-subcap:
#|   - "Maximum amplitude"
#|   - "Decay rate"
#| layout-ncol: 2
...
We visualise the datasets in the style of manuscript figure 2 in @fig-q2-overview.

```{r}
#| label: fig-q2-overview
#| fig-cap: "WT measurements across three `LPR`s and three experimental conditions, representing figures 2B, 2D, and 2F from the draft manuscript."
#| fig-width: 10
#| fig-height: 15
...
- [Download `01_fig2_amplitude.csv`](assets/data/01_fig2_amplitude.csv)
- [Download `01_fig2_rate.csv`](assets/data/01_fig2_rate.csv)
...
#EMM_d <- rbind(EMM_lpr5_amp_d, EMM_lpr5_k_d)
...
- [Download as .pdf](assets/images/fig02_WT_across_three_conditions_and_LPRs.pdf)
- [Download as .png](assets/images/fig02_WT_across_three_conditions_and_LPRs.png)